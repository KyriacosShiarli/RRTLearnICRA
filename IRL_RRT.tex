...
% on the last page of the documentk
...
\hline
                        & RLT* & RLT-NC \\ \hline
Average Cost Difference & 0.1  & 2.31   \\ \hline
Learning time (s)       & 1320 & 18530  \\ \hline
\end{tabular}
\end{table}
...
In future work, we hope to extend RLT$^*$ to model how features evolve over time, in order to, e.g., consider people's movement during planning.  For complex social path planning applications, periodic replanning has been shown to help \cite{henry2010learning,vasquez2014inverse}. Replanning in RRT$^*$ is also possible \cite{otte2015rrtx} and could potentially be incorporated into RLT$*$. Another interesting avenue for future work is to attempt learning using other sample based planning methods such as Batch Informed Trees (BIT$^*$) \cite{gammell2015batch} which are faster and thus perhaps more appropriate for tasks such as manipulation.
